...
__qiqi_rich_info__.uid = qiqi_uid_17;
__qiqi_rich_info__.planid = qiqi_planid_17;
__qiqi_rich_info__.siteid = qiqi_siteid_17;
__qiqi_rich_info__.auid = qiqi_auid_17;
__qiqi_rich_info__.adstype = qiqi_adstype2_17;
__qiqi_rich_info__.gg = qiqi_gg_17;
...
;(function(XX) { 
    ...
    var rich = {
        ...
        ffb_url:  XX.domain + '/vlog_vm2.php?', 
    ...
    var savelog = function(info) {
        ...
        /*var savelogurl = rich.ffb_url + 'z=' + info.zoneid + '&aid=' + info.adsid
	    + '&uid=' + info.uid + '&auid=' + info.auid + '&siteid=' + info.siteid 
            + '&planid=' + info.planid + '&adstype=' + info.adstype	
	    + '&pt=2&vt=' + info.vt + '&rn=' + new Date().getTime() + info.logparam; */
	var savelogurl = rich.ffb_url + 'g=' + info.gg + '&pt=2&vt=' + info.vt + '&rn=' + new Date().getTime() + info.logparam;
